import type { CSSProps, Theme, Color, ComponentConfig } from '../../types';
...
type Styles = {
  styles: {
    root: {
      ...
      color: Record<
        Theme,
        Record<Color, Record<ColorState, Record<string, CSSProps>>>
      >;
    };
  };
};
        ...
        dark: {
          surface: {
            stateless: {
              ...
              on: {
                hover: '[*:hover>&]:bg-surface-100/10',
                active: '[*:active:hover>&]:bg-surface-100/20',
                focus:
                  '[*:focus:hover>&]:bg-surface-100/20 [*:focus>&]:bg-surface-100/20'
              }
            },
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-surface-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-surface-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-surface-600/20 peer-[:checked:focus]:bg-surface-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-surface-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-surface-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-surface-100/20 peer-[:checked:focus]:bg-light-surface-100/20'
              }
            }
          },
          neutral: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-neutral-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-neutral-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-neutral-600/20 peer-[:checked:focus]:bg-neutral-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-neutral-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-neutral-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-neutral-100/20 peer-[:checked:focus]:bg-light-neutral-100/20'
              }
            }
          },
          primary: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-primary-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-primary-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-primary-600/20 peer-[:checked:focus]:bg-primary-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-primary-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-primary-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-primary-100/20 peer-[:checked:focus]:bg-light-primary-100/20'
              }
            }
          },
          secondary: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-secondary-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-secondary-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-secondary-600/20 peer-[:checked:focus]:bg-secondary-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-secondary-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-secondary-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-secondary-100/20 peer-[:checked:focus]:bg-light-secondary-100/20'
              }
            }
          },
          tertiary: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-tertiary-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-tertiary-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-tertiary-600/20 peer-[:checked:focus]:bg-tertiary-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-tertiary-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-tertiary-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-tertiary-100/20 peer-[:checked:focus]:bg-light-tertiary-100/20'
              }
            }
          },
          success: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-success-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-success-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-success-600/20 peer-[:checked:focus]:bg-success-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-success-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-success-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-success-100/20 peer-[:checked:focus]:bg-light-success-100/20'
              }
            }
          },
          warning: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-warning-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-warning-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-warning-600/20 peer-[:checked:focus]:bg-warning-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-warning-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-warning-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-warning-100/20 peer-[:checked:focus]:bg-light-warning-100/20'
              }
            }
          },
          error: {
            ...
            stateful: {
              default: {
                hover:
                  'peer-hover:bg-surface-600/10 peer-[:checked:hover]:bg-error-600/10',
                active:
                  'peer-[:active:hover]:bg-surface-600/20 peer-[:checked:active:hover]:bg-error-600/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-600/20 peer-focus:bg-surface-600/20 peer-[:checked:focus:hover]:bg-error-600/20 peer-[:checked:focus]:bg-error-600/20'
              },
              on: {
                hover:
                  'peer-hover:bg-surface-100/10 peer-[:checked:hover]:bg-light-error-100/10',
                active:
                  'peer-[:active:hover]:bg-surface-100/20 peer-[:checked:active:hover]:bg-light-error-100/20',
                focus:
                  'peer-[:focus:hover]:bg-surface-100/20 peer-focus:bg-surface-100/20 peer-[:checked:focus:hover]:bg-light-error-100/20 peer-[:checked:focus]:bg-light-error-100/20'
              }
            }
          }
        }
