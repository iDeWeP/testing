...
export const TransitionExample = () => (
  <ExampleSection title="Transition">
    <ExampleUnstyledTransition transition="fade">
      FADE
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="grow">
      GROW
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="grow-fade">
      GROW-FADE
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="slide-top">
      SLIDE-TOP
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="slide-bottom">
      SLIDE-BOTTOM
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="slide-left">
      SLIDE-LEFT
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="slide-right">
      SLIDE-RIGHT
    </ExampleUnstyledTransition>
    ...
    <ExampleUnstyledTransition transition="collapse-x">
      COLLAPSE-X
    </ExampleUnstyledTransition>
    <ExampleUnstyledTransition transition="collapse-y">
      COLLAPSE-Y
    </ExampleUnstyledTransition>
