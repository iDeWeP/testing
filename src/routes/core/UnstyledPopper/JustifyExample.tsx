...
export const JustifyExample = () => (
  <ExampleSection title="Justify">
    <ExampleCard>
      <ExampleUnstyledPopper justify="normal">
      ...
      <ExampleUnstyledPopper justify="stretch">
      ...
      <ExampleUnstyledPopper justify="start">
      ...
      <ExampleUnstyledPopper justify="end">
      ...
      <ExampleUnstyledPopper justify="center">
      ...
      <ExampleUnstyledPopper justify="evenly">
      ...
      <ExampleUnstyledPopper justify="between">
      ...
      <ExampleUnstyledPopper justify="around">
