...
export const JustifyExample = () => (
  <ExampleSection title="Justify">
    <ExampleCard
      ...
      stretch
    >
      <ExampleUnstyledPaper justify="normal">
      ...
      <ExampleUnstyledPaper justify="stretch">
      ...
      <ExampleUnstyledPaper justify="start">
      ...
      <ExampleUnstyledPaper justify="end">
      ...
      <ExampleUnstyledPaper justify="center">
      ...
      <ExampleUnstyledPaper justify="evenly">
      ...
      <ExampleUnstyledPaper justify="between">
      ...
      <ExampleUnstyledPaper justify="around">
